...
function dictValueParserRoyaltyParams(): DictionaryValue<RoyaltyParams> {
 ...
 type Insurance_init_args = {
    $$type: 'Insurance_init_args';
    collection: Address;
}

function initInsurance_init_args(src: Insurance_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.collection);
    };
...
async function Insurance_init(collection: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initInsurance_init_args({ $$type: 'Insurance_init_args', collection })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const Insurance_errors: { [key: number]: { message: string } } = {
...
const Insurance_getters: ABIGetter[] = [
    {"name":"time_left","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"insurance_data","arguments":[],"returnType":{"kind":"simple","type":"InsuranceData","optional":false}},
    {"name":"balance","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]

const Insurance_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"empty"}},
    {"receiver":"internal","message":{"kind":"text","text":"withdraw all"}},
    {"receiver":"internal","message":{"kind":"typed","type":"GratzWithdrawAll"}},
    {"receiver":"internal","message":{"kind":"typed","type":"InternalScam"}},
    {"receiver":"internal","message":{"kind":"typed","type":"InternalPay"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class Insurance implements Contract {
    
    static async init(collection: Address) {
        return await Insurance_init(collection);
    }
    
    static async fromInit(collection: Address) {
        const init = await Insurance_init(collection);
        const address = contractAddress(0, init);
        return new Insurance(address, init);
    }
    ...
    readonly abi: ContractABI = {
        ...
        getters: Insurance_getters,
        receivers: Insurance_receivers,
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | 'withdraw all' | GratzWithdrawAll | InternalScam | InternalPay | Deploy) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'GratzWithdrawAll') {
            body = beginCell().store(storeGratzWithdrawAll(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'InternalScam') {
            body = beginCell().store(storeInternalScam(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'InternalPay') {
            body = beginCell().store(storeInternalPay(message)).endCell();
        }
    ...
    async getTimeLeft(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('time_left', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
    
    async getInsuranceData(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('insurance_data', builder.build())).stack;
        const result = loadTupleInsuranceData(source);
        return result;
    }
