...
import { LikedCollections } from "src/contracts/nft_collections/nft_collection-liked.model";
import { NftCollectionTable } from "src/contracts/nft_collections/nft_collections.model";
import { LikedNft } from "src/contracts/nfts/nfts-liked.model";
...
export class User extends Model<User, UserCreationAttributes> {
    ...
    @ApiProperty({ type: [Nft], default: [] })
    @BelongsToMany(() => Nft, () => LikedNft)
    liked_nfts: Nft[]

    @ApiProperty({ type: [NftCollectionTable], default: [] })
    @BelongsToMany(() => NftCollectionTable, () => LikedCollections)
    liked_collections: NftCollectionTable[]
}