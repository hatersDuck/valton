...
import { NftsService } from 'src/contracts/nfts/nfts.service';
import { NftCollectionsService } from 'src/contracts/nft_collections/nft_collections.service';
...
export class UsersService {
    constructor(
        ...
        private nftCollectionService: NftCollectionsService
    ) { }
    ...
    async allInfo(address: string): Promise<AllInfoUserDto> {
        ...
        rtn.nfts = await this.nftsService.findAllNftOwner(address)
        return rtn;
    }
