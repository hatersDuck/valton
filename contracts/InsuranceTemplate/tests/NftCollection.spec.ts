...
describe('NftCollection', () => {
    ...
    it ("should insurance pay",async () => {
        ...
        for (let i = 0; i < COUNT_USERS; i++) {
            ...
            console.log(transact.events[transact.events.length - 1])
        }
        expect(BigInt(await insurance.getBalance())).toEqual(0n)
    });
    ...
    it ("should withdraw all coins", async () => {
        ...
        console.log(transact.events)
        console.log(before_balance_deployer, after_balance_deployer);
